...
class acf_field_ndla_image extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('NDLA Image', 'acf-ndla_image');
		...
		*  var message = acf._e('ndla_image', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-ndla_image'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-ndla_image'),
			'instructions'	=> __('Customise the input font size','acf-ndla_image'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-ndla_image', "{$url}assets/js/input.js", array('acf-input'), $version );
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-ndla_image'),
		}
